...
BOT_TOKEN = "8217285098:AAGZ4hZyXaTUq89h_JSPFQLkbpQ1hzRhy9o"
...
API_URLS = [
    ...
    "https://juanidniz-pw-orpin.vercel.app/api/tempotp?type=sms",
...
async def send_to_all_groups(message):
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text="📱 Channel", url="https://t.me/sarkarmethod"),
